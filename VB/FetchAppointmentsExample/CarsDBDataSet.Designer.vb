...
Namespace FetchAppointmentsExample
	...
	End Class
End Namespace
Namespace FetchAppointmentsExample.CarsDBDataSetTableAdapters
	...
	Partial Public Class CarSchedulingTableAdapter
		...
		Private Sub InitCommandCollection()
			...
			Me._commandCollection(1).CommandText = "SELECT * " & Constants.vbCrLf & "FROM CarScheduling " & Constants.vbCrLf & "WHERE ((StartTime >= :From) AND (StartTime <= :To" & ")) " & Constants.vbCrLf & "OR ((EndTime >= :From)  AND (EndTime <= :To)) " & Constants.vbCrLf & "OR ((StartTime < :From) AND" & " (EndTime > :To)) " & Constants.vbCrLf & "OR (EventType = 1)" & Constants.vbCrLf
			Me._commandCollection(1).CommandType = Global.System.Data.CommandType.Text
			Me._commandCollection(1).Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("From", Global.System.Data.OleDb.OleDbType.DBTimeStamp, 0, Global.System.Data.ParameterDirection.Input, (CByte(0)), (CByte(0)), Nothing, Global.System.Data.DataRowVersion.Current, False, Nothing))
			Me._commandCollection(1).Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("To", Global.System.Data.OleDb.OleDbType.DBTimeStamp, 0, Global.System.Data.ParameterDirection.Input, (CByte(0)), (CByte(0)), Nothing, Global.System.Data.DataRowVersion.Current, False, Nothing))
		End Sub
		...
		Public Overridable Function FillBy(ByVal dataTable As CarsDBDataSet.CarSchedulingDataTable, ByVal [From] As System.DateTime, ByVal [To] As System.DateTime) As Integer
			Me.Adapter.SelectCommand = Me.CommandCollection(1)
			Me.Adapter.SelectCommand.Parameters(0).Value = (CDate([From]))
			Me.Adapter.SelectCommand.Parameters(1).Value = (CDate([To]))
			If (Me.ClearBeforeFill = True) Then
				dataTable.Clear()
			End If
			Dim returnValue As Integer = Me.Adapter.Fill(dataTable)
		...
		Public Overridable Function GetDataBy(ByVal [From] As System.DateTime, ByVal [To] As System.DateTime) As CarsDBDataSet.CarSchedulingDataTable
			Me.Adapter.SelectCommand = Me.CommandCollection(1)
			Me.Adapter.SelectCommand.Parameters(0).Value = (CDate([From]))
			Me.Adapter.SelectCommand.Parameters(1).Value = (CDate([To]))
			Dim dataTable As New CarsDBDataSet.CarSchedulingDataTable()
