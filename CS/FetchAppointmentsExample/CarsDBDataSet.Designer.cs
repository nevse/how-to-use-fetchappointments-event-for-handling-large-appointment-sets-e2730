...
namespace FetchAppointmentsExample.CarsDBDataSetTableAdapters {
    ...
    public partial class CarsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::FetchAppointmentsExample.Properties.Settings.Default.CarsDBConnectionString;
        }
    ...
    public partial class CarSchedulingTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = "SELECT * \r\nFROM CarScheduling \r\nWHERE ((StartTime >= :From) AND (StartTime <= :To" +
                ")) \r\nOR ((EndTime >= :From)  AND (EndTime <= :To)) \r\nOR ((StartTime < :From) AND" +
                " (EndTime > :To)) \r\nOR (EventType = 1)\r\n";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1].Parameters.Add(new global::System.Data.OleDb.OleDbParameter("From", global::System.Data.OleDb.OleDbType.DBTimeStamp, 0, global::System.Data.ParameterDirection.Input, ((byte)(0)), ((byte)(0)), null, global::System.Data.DataRowVersion.Current, false, null));
            this._commandCollection[1].Parameters.Add(new global::System.Data.OleDb.OleDbParameter("To", global::System.Data.OleDb.OleDbType.DBTimeStamp, 0, global::System.Data.ParameterDirection.Input, ((byte)(0)), ((byte)(0)), null, global::System.Data.DataRowVersion.Current, false, null));
        }
        ...
        public virtual int FillBy(CarsDBDataSet.CarSchedulingDataTable dataTable, System.DateTime From, System.DateTime To) {
        ...
        public virtual CarsDBDataSet.CarSchedulingDataTable GetDataBy(System.DateTime From, System.DateTime To) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            this.Adapter.SelectCommand.Parameters[0].Value = ((System.DateTime)(From));
            this.Adapter.SelectCommand.Parameters[1].Value = ((System.DateTime)(To));
            CarsDBDataSet.CarSchedulingDataTable dataTable = new CarsDBDataSet.CarSchedulingDataTable();
