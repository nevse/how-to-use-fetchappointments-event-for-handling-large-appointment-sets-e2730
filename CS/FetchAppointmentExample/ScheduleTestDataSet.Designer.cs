...
SELECT UniqueID, Type, StartDate, EndDate, AllDay, Subject, Location, Description, Status, Label, ResourceID, ResourceIDs, ReminderInfo, RecurrenceInfo, CustomField1 FROM Appointments WHERE (UniqueID = @UniqueID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::FetchAppointmentExample.Properties.Settings.Default.ScheduleTestConnectionString1;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].Connection = new global::System.Data.SqlClient.SqlConnection(global::FetchAppointmentExample.Properties.Settings.Default.ScheduleTestConnectionString1);
            this._commandCollection[1].CommandText = @"SELECT       Appointments.*
FROM         Appointments
...
";
        ...
        public virtual int FillBy(ScheduleTestDataSet.AppointmentsDataTable dataTable, global::System.Nullable<global::System.DateTime> From, global::System.Nullable<global::System.DateTime> To) {
